...
import type { ReadRootGetData, ApiCheckoutApiCheckoutPostData, ApiCheckoutApiCheckoutPostError, GetPaymentApiPaymentPostData, GetPaymentApiPaymentPostError, LoginApiAuthLoginPostData, LoginApiAuthLoginPostError, GetAirportsApiAirportGetData, GetAirportsApiAirportGetResponse, GetTestApiTestGetData, ApiSearchFlightApiFlightGetData, ApiSearchFlightApiFlightGetError } from './types.gen';
 ...
 * get all airports
 */
export const getAirportsApiAirportGet = <ThrowOnError extends boolean = false>(options?: Options<GetAirportsApiAirportGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAirportsApiAirportGetResponse, unknown, ThrowOnError>({
        url: '/api/airport',
        ...options
    });
};
