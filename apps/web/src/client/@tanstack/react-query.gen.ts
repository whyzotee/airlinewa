...
import { type Options, airportGetAirports, userUsers, authLogin, flightSearchFlight, paymentPayments, paymentCheckout, paymentPaymentGateway, paymentPaymentSuccess, utilsTestEmail, utilsHealthCheck } from '../sdk.gen';
import { queryOptions, type UseMutationOptions } from '@tanstack/react-query';
import type { AirportGetAirportsData, UserUsersData, AuthLoginData, AuthLoginError, FlightSearchFlightData, PaymentPaymentsData, PaymentPaymentsError, PaymentCheckoutData, PaymentCheckoutError, PaymentPaymentGatewayData, PaymentPaymentGatewayError, PaymentPaymentSuccessData, UtilsTestEmailData, UtilsTestEmailError, UtilsHealthCheckData } from '../types.gen';
