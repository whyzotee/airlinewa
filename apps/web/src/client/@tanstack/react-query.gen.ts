...
import { type Options, readRootGet, apiCheckoutApiCheckoutPost, getPaymentApiPaymentPost, loginApiAuthLoginPost, getAirportsApiAirportGet, getTestApiTestGet, apiSearchFlightApiFlightGet } from '../sdk.gen';
import { queryOptions, type UseMutationOptions } from '@tanstack/react-query';
import type { ReadRootGetData, ApiCheckoutApiCheckoutPostData, ApiCheckoutApiCheckoutPostError, GetPaymentApiPaymentPostData, GetPaymentApiPaymentPostError, LoginApiAuthLoginPostData, LoginApiAuthLoginPostError, GetAirportsApiAirportGetData, GetTestApiTestGetData, ApiSearchFlightApiFlightGetData } from '../types.gen';
...
export const getAirportsApiAirportGetQueryKey = (options?: Options<GetAirportsApiAirportGetData>) => createQueryKey('getAirportsApiAirportGet', options);

export const getAirportsApiAirportGetOptions = (options?: Options<GetAirportsApiAirportGetData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getAirportsApiAirportGet({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getAirportsApiAirportGetQueryKey(options)
    });
};
