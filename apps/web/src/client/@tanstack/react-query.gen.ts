...
import { type Options, airportGetAirports, userUsers, authLogin, flightSearchFlight, bookingBookings, bookingBooking, paymentPayments, paymentCheckout, paymentPaymentCancel, paymentPaymentGateway, paymentPaymentSuccess, utilsTestEmail, utilsHealthCheck } from '../sdk.gen';
import { queryOptions, type UseMutationOptions } from '@tanstack/react-query';
import type { AirportGetAirportsData, UserUsersData, AuthLoginData, AuthLoginError, AuthLoginResponse, FlightSearchFlightData, BookingBookingsData, BookingBookingData, PaymentPaymentsData, PaymentPaymentsError, PaymentCheckoutData, PaymentCheckoutError, PaymentPaymentCancelData, PaymentPaymentCancelError, PaymentPaymentGatewayData, PaymentPaymentGatewayError, PaymentPaymentSuccessData, UtilsTestEmailData, UtilsTestEmailError, UtilsHealthCheckData } from '../types.gen';
